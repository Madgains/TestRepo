...
const PlanogramView = () => {
    ...
    return (<react_1.Fragment>
      <status_filter_1.default applicationName={"ckb"} moduleName={"planograms"} viewName={"default"} width={200} onStatusChange={statusChange}/>

      <object_data_grid_1.default applicationName={"ckb"} objectType={"planograms"} moduleName={"planograms"} viewName={"default"} apiUrl={"planograms"} filterData={filterData} selectList={"Category, Name, Height, Width, Depth, DBKey, DBCurrentUser, dbstatus"} keyColumn={"DBKey"} dbParentAccountKey={0} staticFilter={""} clearColumnFilter={clearColumnFilter} gridSelectionLimit={1000} paging={true} pageSize={20} pageDropdown={[10, 30, 50, 100]} columns={columns} multiSelect={true} headerCheckboxDropDown={true} tableName={"ix_spc_planogram"}/>
    </react_1.Fragment>);
};
exports.default = PlanogramView;
